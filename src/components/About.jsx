...
const About = () => {
  return (
    <div className="bg-gray-100 py-16 px-6 sm:px-12 md:px-24">
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="w-full md:w-1/3 mb-8 md:mb-0 flex justify-center">
          <img
            src={profilephoto}
            alt="Ashwinram M"
            className="w-48 h-48 md:w-64 md:h-64 rounded-full shadow-xl object-fit"
          />
        </div>

        {/* Description Section */}
        <div className="w-full md:w-2/3 md:pl-12 text-center md:text-left ">
          <h2 className="text-3xl md:text-4xl font-semibold text-indigo-700 mb-4">
            About Me
          </h2>
      ...
      <div className="mt-16 mb-0 border-t-2 border-gray-300"></div>
    </div>
  );
};
